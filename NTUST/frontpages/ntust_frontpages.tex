...
% \newpage{\includepdf{frontpages/my_recommendation_letter.pdf}{\addcontentsline{toc}{chapter}{\nameInnerCover}}}

\newpage
\chapter*{\protect\makebox[8cm][s]{\nameInnerCover}} %\makebox{} is fragile; need protect
\addcontentsline{toc}{chapter}{\nameInnerCover}
\setcounter{page}{2}

\begin{figure}[htbp]
    \centerline{\includegraphics[height=18.5cm]{frontpages/my_recommendation_letter.jpg}}
    \label{fig:reccom}
\end{figure}
\newpage

%\newpage{\begin{figure}[htbp]\centerline{\includegraphics[width=18.0cm]{frontpages/my_recommendation_letter.png}}\end{figure}{\addcontentsline{toc}{chapter}{\nameCopyrightForm}}}
%\newpage
...
% \newpage{\includepdf{frontpages/my_approval_letter.pdf}{\addcontentsline{toc}{chapter}{\nameCommitteeForm}}}

\newpage
\chapter*{\protect\makebox[5cm][s]{\nameCommitteeForm}} %\makebox{} is fragile; need protect
\addcontentsline{toc}{chapter}{\nameCommitteeForm}

\begin{figure}[htbp]
    \centerline{\includegraphics[height=18.5cm]{frontpages/my_approval_letter.jpg}}
    \label{fig:qualif}
\end{figure}
\newpage
