...
應用於 nFAPI 拆分架構在不可預測網路壅塞下之自適應提前時槽機制
}

% 論文題目 (英文)
\renewcommand\eTitle{%My Thesis Title  
Adaptive Slots Ahead for nFAPI Split under Unpredictable network congestion
%My Thesis Title  \mbox{$\cal{H}_\infty$} and \mbox{Al$_x$Ga$_{1-x}$As}
}

% 我的姓名 (中文)
\renewcommand\myCname{徐銘鴻}

% 我的姓名 (英文)
\renewcommand\myEname{Ming-Hong HSU}

%我的學號
\renewcommand\myStudentID{M11302209}

% 指導教授A的姓名 (中文)
\renewcommand\advisorCnameA{鄭瑞光 博士}

% 指導教授A的姓名 (英文)
\renewcommand\advisorEnameA{Dr.~Ray-Guang Cheng}
