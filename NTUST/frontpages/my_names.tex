...
Integration Automation for O-RAN End-to-end Systems
%My Thesis Title  \mbox{$\cal{H}_\infty$} and \mbox{Al$_x$Ga$_{1-x}$As}
}

% 我的姓名 (中文)
\renewcommand\myCname{林柔杉}

% 我的姓名 (英文)
\renewcommand\myEname{Jou-Shan Lin}

%我的學號
\renewcommand\myStudentID{M11102225}
...
% 口試年份 (中文、民國)
\renewcommand\cYear{一百一十四}

% 口試月份 (中文)
\renewcommand\cMonth{七} 

% 口試月份 (中文)
\renewcommand\cDay{二十八} 
