...
\toprule
\textbf{Parameter Name} & \textbf{Field Type} & \textbf{Description} \\
\midrule
\endfirsthead
...
timingWindow-v3 & uint16\_t & Timing window for delay management (with or without timestamps). See section 3.2.9 of [10] \\
timingMode-v3 & uint8\_t & Timing mode for Timing Info or Timing Indication APIs. See section 3.2.9 of [10] \\
timingPeriod-v3 & uint8\_t & Timing period for Timing Info or Timing Indication APIs. See section 3.2.9 of [10] \\
\end{longtable}
