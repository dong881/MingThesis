...
\begin{longtable}{p{1cm}|p{1cm}|p{4cm}|p{2cm}}
\caption{nFAPI Delay Management Configuration Parameters [10]} \\
\toprule
\textbf{Tag} & \textbf{Field Type} & \textbf{Description} & \textbf{Reference} \\
\midrule
\endfirsthead
...
0x011E & uint16\_t & timingWindow-v3: See section 3.2.9 of [10]. Applies to Delay Management with or without Timestamps, whichever is configured. & See section 3.2.9 of [10] \\
0x011F & uint8\_t & timingMode-v3: See section 3.2.9 of [10]. Applies to Timing Info or Timing Indication APIs, depending on whether Delay Management with or without Timestamps is configured. & See section 3.2.9 of [10] \\
0x0120 & uint8\_t & timingPeriod-v3: See section 3.2.9 of [10]. Applies to Timing Info or Timing Indication APIs, depending on whether Delay Management with or without Timestamps is configured. & See section 3.2.9 of [10] \\
\end{longtable}
