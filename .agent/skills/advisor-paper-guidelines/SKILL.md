...
2.  **Color Coding**:
    *   **Blue (`\color{blue}`)**: Content you added yourself. **EXCEPTION**: Do NOT use blue color for **Tables** and **Formulas/Equations**. These should remain in the default black color.
