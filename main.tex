...
\begin{itemize}
\item \textcolor{blue}{\textbf{Delay Modeling in nFAPI Split 6:} We analyze and quantify the non-deterministic latency factors, including network jitter and server processing time, that lead to synchronization failures in disaggregated RAN deployments.}
